    ...
    <>
      ...
      <main className="lg:w-[1024px] w-full m-auto px-4 lg:py-10 pt-10 pb-20">
        <form
          ...
          className="lg:mt-20 mt-6 rounded-full border lg:w-[800px] w-full lg:h-[80px] h-[60px] m-auto border-zinc-200 dark:border-zinc-700 bg-zinc-100 relative dark:bg-darkColor-700 text-sm items-center sm:gap-4 gap-3 sm:pr-6 pr-4 flex"
        >
