...
export default function RegisterSection() {
  return (
    <main className="flex lg:flex-row flex-col items-center w-full h-screen text-my-text-800 bg-white">
      <section className="w-full transition relative lg:h-full h-[300px] flex items-center justify-center bg-linear-to-tl from-[#00b09b] to-[#96c93d]">
        <Link
          href={"/home"}
