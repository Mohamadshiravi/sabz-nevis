    ...
    <section>
      ...
      <section className="grid lg:grid-cols-[8.5fr_3.5fr]">
        <div className="md:px-20 px-4 md:py-12 py-4 w-full">
          ...
          <div className="bg-zinc-200 h-[70px] dark:bg-zinc-800 w-full mt-8 animate-pulse"></div>
          <div className="bg-zinc-200 h-[35px] dark:bg-zinc-800 w-full mt-3 animate-pulse"></div>
          <div className="bg-zinc-200 h-[35px] dark:bg-zinc-800 w-full mt-3 animate-pulse"></div>
          <div className="bg-zinc-200 h-[35px] dark:bg-zinc-800 w-full mt-3 animate-pulse"></div>
          <div className="bg-zinc-200 h-[35px] dark:bg-zinc-800 w-full mt-3 animate-pulse"></div>
        </div>
        <div className="w-full lg:block hidden px-6 md:py-12 py-6">
          <div className="bg-zinc-200 h-[100px] dark:bg-zinc-800 w-[100px] rounded-full animate-pulse"></div>
