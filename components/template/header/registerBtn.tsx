    ...
    <>
      <div className="relative">
        ...
        <div
          ...
          } bg-virgoolBlue flex-col gap-4 rounded-md w-[330px] absolute top-12 left-0 px-5 py-6`}
        >
          <div className="w-[40px] h-[40px] bg-virgoolBlue absolute -top-2 left-4 rotate-45 z-[0]"></div>
          <div className="flex items-center justify-between z-[1]">
            <h4 className="text-white vazir-medium">
              ثبت‌نام برای دسترسی به تمام امکانات ویرگول
            </h4>
            <IoMdClose
              onClick={() => {
