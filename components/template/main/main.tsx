    ...
    <section className="w-full sm:py-14 py-8 flex flex-col gap-8">
      {userData && (
        <div className="flex items-center gap-5 border-b-2 border-zinc-300">
          ...
          <div className="pb-2 vazir-medium px-2 relative text-virgoolText-800 after:content-[''] after:absolute after:w-full after:bottom-[-2px] after:left-0 after:h-[2px] after:bg-virgoolText-800">
            برای شما
          </div>
