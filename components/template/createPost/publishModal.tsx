  ...
  return (
    <>
      ...
      <form
        ...
        } transition duration-300 border z-50 border-zinc-200 dark:border-zinc-800 bg-white dark:bg-dark-color-800 open-animate sm:p-10 p-4 rounded-md shadow-xl no-scrollbar fixed overflow-y-scroll md:h-auto h-[90vh] w-[96%] md:top-[50px] top-[40px] left-[2%]`}
      >
        <div className="grid md:grid-cols-[6fr_6fr] gap-10">
          <div className="flex flex-col gap-4">
            <h3 className="vazir-medium text-my-green-600">پیش نمایش پست</h3>
                  ...
                  <div className="w-full h-full grid grid-cols-[3fr_3fr_3fr_3fr] gap-2 overflow-y-scroll p-1">
                    {images.map((e, i) => (
                      <div
                        ...
                        className={`${
                          e === postCover &&
                          "border-4 border-my-green-600 rounded-md"
            ...
            <div className="relative">
              <textarea
                ...
                dir="rtl"
                className="outline-hidden w-full border-b text-sm min-h-[100px] max-h-[150px] bg-inherit border-zinc-300 dark:border-zinc-700 py-2 mt-4"
          ...
          <div className="flex flex-col gap-4">
            <h3 className="vazir-medium text-my-green-600">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              {categoryLoading
                ? Array.from({ length: 20 }).map((e, i) => (
                    <span
                      key={i}
                      className="w-[100px] animate-pulse h-[30px] rounded-xs bg-zinc-200 dark:bg-zinc-800"
                    ></span>
                  ))
                : categories.map((e, i) => (
                    <span
                      ...
                      } text-sm transition px-3 py-1 rounded-xs cursor-pointer`}
                    >
                      {e.name}
                    </span>
                  ))}
            ...
            <div className="flex items-center gap-1">
              <div className="flex flex-col items-center">
                <span
                  ...
                  className="bg-zinc-200 cursor-pointer hover:bg-zinc-300 dark:bg-zinc-800 dark:hover:bg-zinc-700 border border-zinc-400 dark:border-zinc-600 text-sm transition px-2 py-1 rounded-xs cursor-pointer"
                >
                  <IoIosArrowUp />
                </span>
