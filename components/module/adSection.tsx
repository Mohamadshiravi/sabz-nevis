...
export default function ADSection() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full sm:h-[400px] h-[300px] flex items-center justify-center bg-myGreen-600 text-white text-4xl vazir-bold">
        <h2>محل تبلیغ شما</h2>
      </div>
      <div className="flex sm:flex-row flex-col sm:gap-0 gap-3 px-4">
        <p className="text-myGreen-600 text-sm pl-4 sm:text-right text-center">
        ...
        <button className="border-2 hover:bg-myGreen-600 hover:text-white transition border-myGreen-600 text-myGreen-600 px-6 vazir-bold text-nowrap text-xs rounded-full h-[40px]">
          خرید رپوتاژ اگهی
        </button>
      </div>
    </div>
