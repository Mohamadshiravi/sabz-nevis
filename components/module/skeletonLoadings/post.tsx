  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between mt-3 w-full">
        ...
        <div className="sm:w-[150px] sm:h-[120px] w-[110px] h-[90px] rounded-xs bg-zinc-200 dark:bg-zinc-800 animate-pulse" />
      </div>
      <div className="w-full flex justify-between mt-8">
        <div className="bg-zinc-200 dark:bg-zinc-800 h-[20px] lg:w-[150px] w-[100px] animate-pulse"></div>
        <div className="flex items-center sm:gap-16 gap-6 text-2xl text-my-text-600">
